...
export const createOrderSchema = z.object({
  body: z.object({
    ...
    cashDueRate: z.coerce.number().positive().optional(),
  ...
  }).refine((value) => !value.cashDueAmount || value.cashDueRate, {
    message: "Cash due rate is required when cash due is entered",
    path: ["cashDueRate"],
  }),
  params: z.object({}).passthrough(),
  query: z.object({}).passthrough(),
